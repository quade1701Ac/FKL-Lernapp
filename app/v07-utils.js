...
function explicitRequestedCount(q){return detectRequestedCount(q?.question||'')}
...
export function scoreAnswerV07(answer,q,fallback){
 if(q.type==='free'&&normalizedAnswer(answer)&&normalizedAnswer(answer)===normalizedAnswer(q.solution))return {score:100,hits:q.keywords||[]};
...
import { normalizedAnswer, detectRequestedCount } from './grading-contract';
